...
class ConstantStrings {
  ...
  static const FORBIDDEN_ACCESS = "Forbiden Access";
  static const REQUEST_NOT_FOUND =
      "The requested information could not be found";
  static const DATA_NOT_FOUND =
      "The data not be found";
  static const NO_INTERNET_CONNECTION =
      "No internet connection detected, please try again.";
  static const CONNECTION_TIME_OUT =
      "The connection has timed out, please try again.";
  static const SEND_TIMEOUT= 'Send Timeout. Please try again.';
  static const RECIEVE_TIMEOUT = 'Receive Timeout. Please try again.';
  static const SOMETHING_WENT_WRONG = "some thing went wrong";
  static const BAD_RESPONSE = 'Received invalid status code: ';
